...
export default function CatalogScreen({ cart, onUpdateCart, onGoToOrder, onGoToHistory }: CatalogScreenProps) {
    ...
    <View style={styles.container}>
      {/* Botón superior para ir al Historial */}
    <View style={styles.headerBar}>
        <Text style={styles.headerTitle}>Catálogo de Menú</Text>
...
const styles = StyleSheet.create({
    ...
    headerBar: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#dcdde1' },
    headerTitle: { fontSize: 20, fontWeight: 'bold', color: '#2f3640' },
    historyButton: { backgroundColor: '#718093', paddingVertical: 6, paddingHorizontal: 12, borderRadius: 6 },
    historyButtonText: { color: '#fff', fontWeight: 'bold', fontSize: 14 },
    listContainer: { padding: 15, paddingBottom: 80 },
    sectionHeader: { fontSize: 18, fontWeight: 'bold', backgroundColor: '#b30707', color: '#fff', paddingVertical: 6, paddingHorizontal: 10, borderRadius: 6, marginVertical: 10 },
    ...
    price: { fontSize: 14, color: '#050100', marginVertical: 4, fontWeight: '600' },
    ...
    cartButton: { position: 'absolute', bottom: 20, left: 20, right: 20, backgroundColor: '#44bd32', padding: 15, borderRadius: 30, alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 5, elevation: 5 },
